$(function(){
  ...
  $(window).resize(function() {
	  ...
	  new_height = (new_height - $('.page_block_5 .page_inner_wrapper').height()- $('.page_block_5 .page_outer_wrapper').attr('top') )/2 - 10;
	  $('.page_block_5 .page_outer_wrapper').css({top: new_height + 'px'});
