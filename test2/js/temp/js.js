$(function(){
    ...
    $(window).scroll(function(){
		var scrollway= 'up';
		 ...
		 if (st > lastScrollTop){
       		$('.screen_ancore').on('inview', function(event, isInView) {
  			if (isInView) {
			/*	scroll_to = -1; /* no scroll */
			/*	switch( $(event.target).attr('id')){
					case "screen_page_1" :
						scroll_to = $('#screen_page_1').offset().top;
						break;
					case "screen_page_2" :
						scroll_to = $('#screen_page_3').offset().top;
						break;
					case "screen_page_3" :
						scroll_to = $('#screen_page_4').offset().top;
						break;
					case "screen_page_4":
						scroll_to = $('#screen_page_5').offset().top;
						break;
					case "screen_page_5":
						scroll_to = $('#screen_page_6').offset().top;
						break;
					case "screen_page_6":
						scroll_to = $('#screen_page_7').offset().top;
						break;
					case "screen_page_7":
						scroll_to = $('#screen_page_8').offset().top;
						break;
				}
			  /*  = $(event.target).offset().top; */
     			...
     			if(lastScrollTop < $('#screen_page_2').offset().top){
					scroll_to = $('#screen_page_2').offset().top;
				 }else if(lastScrollTop < $('#screen_page_3').offset().top){
					 scroll_to = $('#screen_page_3').offset().top;
				 }else if(lastScrollTop < $('#screen_page_4').offset().top){
					 scroll_to = $('#screen_page_3').offset().top;
				  }else if(lastScrollTop < $('#screen_page_4').offset().top){
					 scroll_to = $('#screen_page_3').offset().top;
				  }else if(lastScrollTop < $('#screen_page_5').offset().top){
					 scroll_to = $('#screen_page_3').offset().top;
				  }else if(lastScrollTop < $('#screen_page_5').offset().top){
					 scroll_to = $('#screen_page_3').offset().top;
				  }else if(lastScrollTop < $('#screen_page_6').offset().top){
					 scroll_to = $('#screen_page_3').offset().top;
				  }else if(lastScrollTop < $('#screen_page_6').offset().top){
					 scroll_to = $('#screen_page_3').offset().top;
				 }else if(lastScrollTop < $('#screen_page_7').offset().top){
					 scroll_to = $('#screen_page_7').offset().top;
				 }
	...
	$('.page_title').on('inview', function(event, isInView) {
		if (isInView) {
		/*	var scroll_to = $(event.target).find('.page_title_over > div > span:nth-child(1) > span:first-child').offset().top;
			$('html, body').animate({scrollTop: scroll_to}, 500); */
